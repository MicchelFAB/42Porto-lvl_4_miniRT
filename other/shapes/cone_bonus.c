...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/11 18:52:38 by bmonteir          #+#    #+#             */
/*   Updated: 2024/05/13 12:32:41 by mamaral-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_bhask	ft_bhask_form_cone(t_ray ray)
{
	...
	bhask.a = ray.direction.x * ray.direction.x - ray.direction.y
		* ray.direction.y + ray.direction.z * ray.direction.z;
	bhask.b = 2 * ray.origin.x * ray.direction.x - 2 * ray.origin.y
		* ray.direction.y + 2 * ray.origin.z * ray.direction.z;
	bhask.c = ray.origin.x * ray.origin.x - ray.origin.y * ray.origin.y
