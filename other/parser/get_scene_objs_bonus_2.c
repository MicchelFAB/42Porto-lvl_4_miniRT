...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   get_scene_objs_bonus_2.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mamaral- <mamaral-@student.42porto.com>    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/15 21:28:16 by bmonteir          #+#    #+#             */
/*   Updated: 2024/05/19 19:34:07 by mamaral-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (scene->bonus_qtys[0] > 1 || scene->bonus_qtys[1] > 1
		|| scene->bonus_qtys[2] > 1 || scene->bonus_qtys[3] > 1)
		return (0);
	return (1);
}
...
void	get_9_tr(t_scene *scene)
{
	...
	scene->new->triangle->p1 = ft_vector(scene->new->triangle->p1.x,
			scene->new->triangle->p1.y, scene->new->triangle->p1.z);
	scene->new->triangle->p2 = ft_get_coord(scene->split[2], TR_P2, scene);
	scene->new->triangle->p2 = ft_vector(scene->new->triangle->p2.x,
			scene->new->triangle->p2.y, scene->new->triangle->p2.z);
	scene->new->triangle->p3 = ft_get_coord(scene->split[3], TR_P3, scene);
	scene->new->triangle->p3 = ft_vector(scene->new->triangle->p3.x,
			scene->new->triangle->p3.y, scene->new->triangle->p3.z);
	ft_set_triangle_points(scene->new->triangle, scene->new->triangle->p1,
